...
const baseItemClasses =
  "group flex flex-col md:flex-row items-center md:gap-3 rounded-lg md:rounded-xl px-2 md:px-4 py-2 md:py-3 text-[10px] md:text-sm transition-colors duration-200";
